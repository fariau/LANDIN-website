...
const articles: Article[] = [
  {
    ...
    summary:
      "Step-by-step guide for startups to set up their Shopify store, including themes, products, and checkout setup.",
    date: "Sep 23, 2025",
    category: "Ecommerce",
    cta: "Read More",
  },
  {
    ...
    summary:
      "Design tips to improve usability, conversions, and engagement on your website without heavy coding.",
    date: "Sep 15, 2025",
  ...
  },
  {
    ...
    summary:
      "Learn how to optimize your website content for search engines and increase organic traffic.",
    date: "Sep 10, 2025",
    category: "SEO",
    cta: "Read More",
  },
...
const Blog: FC = () => {
  return (
    ...
    >
      ...
      <motion.h2
        className="mt-6 text-3xl md:text-4xl font-bold text-white text-center mb-14 leading-snug drop-shadow-lg"
        ...
        {articles.map((a, i) => (
          ...
          >
            <div className="rounded-xl bg-black p-6 flex flex-col gap-4 h-full">
              {/* Category */}
              <span className="text-[#592f94] text-sm font-semibold">
                {a.category}
              </span>
